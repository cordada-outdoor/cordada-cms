...
export interface ApiAboutUsPageAboutUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    sections: Schema.Attribute.Component<
      'about-us-person.about-us-person',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    homepageOrder: Schema.Attribute.Integer;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroImages: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    servicesCopy: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
